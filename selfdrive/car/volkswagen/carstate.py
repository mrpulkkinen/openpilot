...
class CarState(CarStateBase):
  ...
  def get_can_parser(CP):
    ...
    signals = [
      ...
      ("GRA_Tip_Stufe_2", "GRA_ACC_01", 0),         # unknown related to button/stalk type
      ("GRA_Typ468", "GRA_ACC_01", 0),              # unknown related to button/stalk type
      ("GRA_ButtonTypeInfo", "GRA_ACC_01", 0),      # unknown related to button/stalk type
